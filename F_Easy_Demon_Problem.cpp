...
void solve() {
    ...
    int initial_beauty = sum_a * sum_b;

    
    set<int> possible_beauties;

    
    for (int i = 0; i < n; ++i) {
        for (int j = 0; j < m; ++j) {
            int decrease = a[i] * sum_b + b[j] * sum_a - a[i] * b[j];
            int new_beauty = initial_beauty - decrease;
            possible_beauties.insert(new_beauty);
        }
    }
